        ...
        <div class="registracija-div">
            <div class="universal-form">
                <form action="" method="post" class="forma">
                    ...
                    <select class="form-input" id="drzava" name="drzava" placeholder="Država"></select><br><br>
                    <label for="moderator" class="form-label">Moderator</label>
                    <select class="form-input" id="moderator" name="moderator" placeholder="Moderator">
                    </select><br><br>
