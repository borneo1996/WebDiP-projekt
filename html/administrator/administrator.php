        ...
        <div class="pocetna-sadrzaj">
            ...
            <div class="sadrzaj-div-4">
                <div class="sadrzaj">
                    ...
                    <p>Pregledajte izdane račune <a href="izdani-racuni.php">ovdje</a>.</p>
                </div>
                <div class="sadrzaj-img">
            ...
            <div class="sadrzaj-div-6">
                <div class="sadrzaj">
                    <button class="adminButton" id="killCookie" onclick=brisiKolacicUvjeta()>Obriši kolačić</button><br>
                </div>
            </div>
